...
### 7. Life Cycle, Development & Biological Unknowns [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]
- **Exact thermal development relationships & degree-day sums [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** Physiological lower development threshold ($T_0$) and effective degree-day thermal constants ($K_{\text{thermal}}$) for *Xylotrupes gideon* complex in Vietnamese climatic conditions have not been verified from peer-reviewed Vietnamese entomological datasets. Current engine constants are provisional gameplay abstractions.
- **Actual wild larval instar durations [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** Captive breeding observations range widely (3 to 9 months for total larval development depending on temperature and wood decay quality). True duration across Northern vs. Southern Vietnamese wild habitats remains unquantified in current project datasets.
- **Wild Vietnamese developmental variation & microclimate influence [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** Extent of phenotypic plasticity in horn size across wild regional populations (e.g., highland Da Lat vs. lowland Mekong Delta) requires field survey corroboration.
- **Substrate & nutritional biochemistry [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** Exact cellulose/lignin breakdown efficiencies, nitrogen requirements, and symbiotic gut microbiota dependencies in indigenous Vietnamese decaying wood types (e.g., decaying bamboo, *Artocarpus*, palm trunks) are unmodeled; simplified gameplay quality indices ($Q_{\text{food}}$) are utilized.
- **Critical hydration and desiccation tolerance limits [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** Precise lethal moisture minimums for eggs, larvae, and pupal cells remain unverified; current thresholds ($< 0.20$ for eggs, $< 0.40$ for pupal ecdysis) are provisional gameplay boundaries.
- **Pupal duration & metamorphic timing [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** Temperature-dependent duration of the pupal stage under natural diurnal oscillations in Vietnam remains uncharacterized; modeled as a baseline thermal constant in prototype configuration.
- **Adult senescence characteristics & wild lifespan [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** Adult male vs. female lifespan in wild Vietnamese habitats (subject to predation, energy expenditure in combat, and sap flow seasonality) is unverified; captive lifespans (2–4 months) serve only as coarse gameplay baselines.
- **Stage-specific mortality curves [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** Natural survivorship curves ($l_x$ life tables) for *Xylotrupes* in Vietnamese forests are unknown; mortality in the simulation is determined deterministically by physiological failure thresholds rather than empirical field mortality percentages.
- **Wild reproduction & clutch oviposition dynamics [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** True wild clutch sizes (15–45 eggs in prototype), post-mating female dispersal, and oviposition substrate selectivity in Vietnamese tropical habitats require entomological field survey validation.
- **Activity rhythms & seasonal diapause [BIOLOGICAL UNKNOWN / REQUIRES VERIFICATION]:** Extent of adult nocturnal activity seasonality in monsoon vs. dry seasons across Vietnamese latitudes remains unverified; treated as a baseline nocturnal preference in prototype configuration.
